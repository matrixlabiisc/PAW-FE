...
\phantomsection\label{parameters:USE GPU}
\label{parameters:USE_20GPU}


\index[prmindex]{USE GPU}
\index[prmindexfull]{USE GPU}
{\it Value:} false
...
\phantomsection\label{parameters:MEM OPT MODE}
\label{parameters:MEM_20OPT_20MODE}


\index[prmindex]{MEM OPT MODE}
\index[prmindexfull]{MEM OPT MODE}
{\it Value:} true
...
\phantomsection\label{parameters:Boundary conditions/MULTIPOLE BOUNDARY CONDITIONS}
\label{parameters:Boundary_20conditions/MULTIPOLE_20BOUNDARY_20CONDITIONS}


\index[prmindex]{MULTIPOLE BOUNDARY CONDITIONS}
\index[prmindexfull]{Boundary conditions!MULTIPOLE BOUNDARY CONDITIONS}
{\it Value:} false
...
\phantomsection\label{parameters:DFT functional parameters/NET CHARGE}
\label{parameters:DFT_20functional_20parameters/NET_20CHARGE}


\index[prmindex]{NET CHARGE}
\index[prmindexfull]{DFT functional parameters!NET CHARGE}
{\it Value:} 0
...
\phantomsection\label{parameters:GPU/USE DCCL}
\label{parameters:GPU/USE_20DCCL}


\index[prmindex]{USE DCCL}
\index[prmindexfull]{GPU!USE DCCL}
{\it Value:} false
...
\phantomsection\label{parameters:SCF parameters/SPIN MIXING ENHANCEMENT FACTOR}
\label{parameters:SCF_20parameters/SPIN_20MIXING_20ENHANCEMENT_20FACTOR}


\index[prmindex]{SPIN MIXING ENHANCEMENT FACTOR}
\index[prmindexfull]{SCF parameters!SPIN MIXING ENHANCEMENT FACTOR}
{\it Value:} 4.0
