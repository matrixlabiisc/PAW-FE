...
namespace dftfe
{
  ...
  public:
       ...
       * @param[in] truncationTol the minimum function value afterwhich the function is truncated.
       * @param[in]  consider0thEntry whether to replace the 0th fn value with the 1st value in the data.
       */    
