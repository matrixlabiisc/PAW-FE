...
template class symmetryClass<5, 11, dftfe::utils::MemorySpace::HOST>;
template class symmetryClass<5, 12, dftfe::utils::MemorySpace::HOST>;
template class symmetryClass<5, 13, dftfe::utils::MemorySpace::HOST>;
...
template class symmetryClass<6, 13, dftfe::utils::MemorySpace::HOST>;
