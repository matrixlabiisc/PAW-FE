...
namespace dftfe
{
  ...
  dispersionCorrection::computeDFTDCorrection()
  {
            ...
            case 1:
              {
                ...
                dftd3_get_dispersion(error,
                                     mol,
                                     disp,
                                     param,
                                     &d_energyDispersion,
                                     d_forceDispersion.data(),
                                     d_stressDispersion.data());
                AssertThrow(dftd3_check_error(error) == 0,
                            dealii::ExcMessage(
                              std::string("Failure in DFTD Module ")));
            ...
            case 2:
              {
                ...
                AssertThrow(false,
                            dealii::ExcMessage(std::string(
                              "DFTFE has not been compiled with dftd4")));
#endif
              }
            default:
              break;
    ...
    d_energyDispersion =
      dealii::Utilities::MPI::broadcast(mpi_communicator_global,
                                        d_energyDispersion,
                                        0);
