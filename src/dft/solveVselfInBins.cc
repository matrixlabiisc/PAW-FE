    ...
    for (unsigned int iBin = 0; iBin < numberBins; ++iBin)
      {
        ...
        dftUtils::constraintMatrixInfo<dftfe::utils::MemorySpace::HOST> constraintsMatrixDataInfo;
          ...
          for (unsigned int idim = 0; idim < 3; idim++)
            {
              ...
              dftUtils::constraintMatrixInfo<dftfe::utils::MemorySpace::HOST> constraintsMatrixDataInfo2;
